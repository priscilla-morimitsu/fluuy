...
description: Conventions for Next.js App Router code — Server vs Client Components, data, actions, env. Apply to files matching: app/**, components/**, lib/**, src/**.
---
...
- Use Route Handlers for webhooks/integrations (e.g. the Pilot Status WhatsApp webhook); prefer Server Actions for your own UI mutations. Validate bodies and params; return correct status codes; never leak stack traces.
